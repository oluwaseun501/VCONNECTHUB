          ...
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              <motion.div key="confirm" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={GLIDE_FAST} className="mt-3 space-y-3">
                ...
                <motion.button
                  whileTap={{ scale: 0.97 }}
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-secondary text-white text-sm font-semibold shadow-lg shadow-primary/25"
                >
                  Purchase Number
                </motion.button>
              </motion.div>
...
function StepCard({ number, title, description }) {
  return (
    <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-primary/25 mb-4">
        {number}
      </div>
      <h3 className="text-foreground font-semibold text-base mb-2">{title}</h3>
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                <Link href="/register">
                  <Button size="lg" className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white border-0 shadow-lg shadow-primary/25 px-6">
      ...
      <section id="how-it-works" className="py-24 bg-muted/30 border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            badge="How it Works"
            title={<>Up and running in <span className="text-gradient">under a minute</span></>}
          />
          <motion.div
            variants={containerVariants}
            initial="hidden"
      ...
      <section className="py-24 px-4">
        <GlideSection>
          <div className="max-w-2xl mx-auto text-center bg-gradient-to-br from-primary/10 to-secondary/10 border border-primary/20 rounded-3xl p-12">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/register">
                <Button size="lg" className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white border-0 shadow-lg shadow-primary/25 px-8">
