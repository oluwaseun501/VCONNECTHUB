...
function FieldSeparator({
  ...
  return (/*#__PURE__*/
    _jsxDEV("div", {
      ...
      _jsxDEV(Separator, { className: "absolute inset-0 top-1/2" }, void 0, false),
      children && /*#__PURE__*/
      _jsxDEV("span", {
        className: "bg-background text-muted-foreground relative mx-auto block w-fit px-2",
        "data-slot": "field-separator-content", children:
  ...
  const content = useMemo(() => {
    ...
    return (/*#__PURE__*/
      _jsxDEV("ul", { className: "ml-4 flex list-disc flex-col gap-1", children:
        errors.map(
          (error, index) =>
          error?.message && /*#__PURE__*/_jsxDEV("li", { children: error.message }, index, false)
        ) }, void 0, false
      ));
