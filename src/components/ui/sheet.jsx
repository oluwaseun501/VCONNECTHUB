...
const SheetContent = /*#__PURE__*/React.forwardRef(
  ...
  _jsxDEV(SheetPortal, { children: [/*#__PURE__*/
    _jsxDEV(SheetOverlay, {}, void 0, false), /*#__PURE__*/
    _jsxDEV(SheetPrimitive.Content, {
      ref: ref,
      className: cn(sheetVariants({ side }), className), ...
      props, children: [/*#__PURE__*/

      _jsxDEV(SheetPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [/*#__PURE__*/
